...
type GetPoolResponse struct {
	...
	MinVm         string                 `protobuf:"bytes,6,opt,name=min_vm,json=minVm,proto3" json:"min_vm,omitempty"`
	MaxVm         string                 `protobuf:"bytes,7,opt,name=max_vm,json=maxVm,proto3" json:"max_vm,omitempty"`
...
func (x *GetPoolResponse) GetMinVm() string {
	if x != nil {
		return x.MinVm
	}
	return ""
...
func (x *GetPoolResponse) GetMaxVm() string {
	if x != nil {
		return x.MaxVm
	}
	return ""
...
func (x *GetPoolResponse) GetMetadata() map[string]string {
	if x != nil {
		return x.Metadata
	}
	return nil
...
const file_frontcontrol_proto_rawDesc = "" +
	...
	"\x04user\x18\x01 \x01(\tR\x04user\x12\x17\n" +
	"\apool_id\x18\x02 \x01(\tR\x06poolId\"\xb9\x02\n" +
	...
	"\x06min_vm\x18\x06 \x01(\tR\x05minVm\x12\x15\n" +
	"\x06max_vm\x18\a \x01(\tR\x05maxVm\x12G\n" +
	"\bmetadata\x18\b \x03(\v2+.frontcontrol.GetPoolResponse.MetadataEntryR\bmetadata\x1a;\n" +
...
var file_frontcontrol_proto_goTypes = []any{
	...
	nil,                              // 30: frontcontrol.GetPoolResponse.MetadataEntry
...
var file_frontcontrol_proto_depIdxs = []int32{
	...
	30, // 2: frontcontrol.GetPoolResponse.metadata:type_name -> frontcontrol.GetPoolResponse.MetadataEntry
