...
func Start_grpc(ctx context.Context) {
	...
	mux.HandleFunc("/api/moodle/login", handleMoodleLogin)
	mux.HandleFunc("/api/moodle/session", handleMoodleSession)
	mux.HandleFunc("/api/moodle/my-pools", handleMoodleMyPools)
	...
	mux.HandleFunc("/api/xcours/status", handleXCoursStatus)
	mux.HandleFunc("/api/xcours/catalogue", handleXCoursCatalogue)
	...
	mux.HandleFunc("/api/announcement", handleAnnouncement)
	mux.HandleFunc("/api/admin/announcement", handleAdminAnnouncement)
