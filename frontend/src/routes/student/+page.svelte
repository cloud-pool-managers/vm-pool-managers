<script lang="ts">
  ...
  // Collaboration : choix de l'éditeur — Jupyter (temps réel auto, sur la VM infra) ou
  // VS Code (temps réel via OCT : Share/Join dans l'éditeur, serveur OCT sur la VM infra).
  let collabEditor = $state<'jupyter' | 'vscode'>('jupyter');
